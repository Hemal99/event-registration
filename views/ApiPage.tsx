...
// FILE: app/api/attendees/upload/route.ts
...
// FILE: app/api/attendees/verify/[id]/route.ts
            ...
            <div className="flex items-start space-x-4">
                ...
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">
                        We are using the Next.js App Router. Files inside the <code className="bg-gray-200 dark:bg-gray-700 rounded px-1.5 py-1 text-xs">app/api</code> directory become automatic server-side endpoints.
                    </p>
                </div>
            </div>
        </div>
